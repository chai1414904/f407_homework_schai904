...
按键中断控制绿灯时，加入简单消抖。
按下按钮后，EXTI 检测上升沿，调用按键回调。50 毫秒内的重复触发会被忽略，减少机械接触抖动造成的连续翻转。中断内没有使用可能导致卡住的延时函数。见 [按键回调 (line 232)](D:/Robomaster/resources/STMproject/Clocksystemblack/Core/Src/main.c:232)]
